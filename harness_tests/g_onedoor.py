...
28 of those touch memory. SP_DECIDE is a model-driven autonomous SUPERSEDE pass — it RETIRES his
facts. SP_FORGET is autonomous forgetting. SP_MEM_LIFECYCLE writes tombstones from a different code
...
with autonomous forgetting armed, the profile says nothing about it, and his memories quietly start
going away.
...
# and the memory-touching ones specifically, because those are the ones that cost him something
...
check("...including the %d that can WRITE or RETIRE his memories" % len(hot),
